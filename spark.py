...
## para iniciar o console, digitar comando pyspark
...
# load in the data
data = sc.textFile("/home/bruna/Área de trabalho/Python Courses/Recommender Systems and Deep Learning (Udemy)/recommender_system_codes/dataset/ml-25m/small_ratings.csv")
